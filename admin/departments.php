...
<head>
    <meta charset="utf-8" />
    <title>Departments - Ultrapic</title>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
                                            ...
                                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#add">Add Department</button>
                                        </div>
                                            ...
                                            <table id="file-datatable" class="table table-bordered data-responsive key-buttons"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th data-ordering="false">Departments</th>
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $get_students = "SELECT * FROM  departments ";
                                                                ...
                                                                <div class="modal-content">
                                                                    <form action="controller/generalController.php" method="post">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="exampleModalScrollableTitle">Edit Department</h5>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="hidden" name="redirect" value="departments.php">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="submit" name="edit_add_department" class="btn btn-success">Save changes</button>
                                                                        </div>
                                                                    </form>
                                                                </div><!-- /.modal-content -->
                                                            </div><!-- /.modal-dialog -->
                                                        ...
                                                        <div class="modal fade" id="delete<?php echo $count; ?>" tabindex="-1"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-scrollable">
                                                                <div class="modal-content">
                                                                    <form action="controller/generalController.php" method="post">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title text-danger" id="exampleModalScrollableTitle">Delete Department</h5>
                                                                            <button type="button" class="btn-close"
                                                                                data-bs-dismiss="modal" aria-label="Close">
                                                                            </button>
                                                                        </div>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <center>
                                                                                ...
                                                                                <p>You are about to delete this department: <br><?php echo $department; ?></p>
                                                                            </center>
                                                                            <input type="hidden" name="redirect" value="departments.php">
                                                                            <input type="hidden" name="table" value="departments">
                                                                            <input type="hidden" name="id" value="<?php echo $department_id; ?>">
